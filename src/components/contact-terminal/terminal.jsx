...
export default function Terminal({ open, setOpen }) {
    ...
    return (
                    ...
                    <div className="row g-2">
                        <div className="col-12">
                            <div className={styles['form-row']}>
                                ...
                                <input type="text" placeholder='{Enter}' name='name' id='name' className={styles['input']} required />
                            </div>
                        </div>
                        <div className="col-12">
                            <div className={styles['form-row']}>
                                ...
                                <span>.....<span className="d-none d-md-inline">.......</span></span>
                                <input type="email" placeholder='{Enter}' name='email' id='email' className={styles['input']} required />
                            </div>
                        </div>
                        <div className="col-12">
                            <div className={styles['form-row']}>
                                ...
                                <span>...<span className="d-none d-md-inline">.......</span></span>
                                <input type="text" placeholder='{Enter}' name='subject' id='subject' className={styles['input']} required />
                            </div>
                        </div>
                        <div className="col-12">
                            <div className={styles['form-row']}>
                                ...
                                <span>...<span className="d-none d-md-inline">.......</span></span>
                                <textarea className={styles.input} placeholder='{Enter}' name="message" id="message" rows="1" required></textarea>
                            </div>
                        </div>
                        <div className="col-12">
        ...
        <motion.div className={styles.terminalOverlay} animate={open ? "open" : "close"} onClick={setOpen} variants={overlayVar}></motion.div>
        </>
    )
}